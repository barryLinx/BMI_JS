...
function UIpagination(pag_len) {
  ...
  var pag_click = _toConsumableArray(document.querySelectorAll('.pag-click')); //console.log(pag_click);
  ...
  pag_click.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      e.preventDefault();
      UIdisplay(e.target.innerText); // console.log(e.target.innerText);
    });
  });
}
/**
...
/******/ })()
;
//# sourceMappingURL=app.49d80ac6.js.map